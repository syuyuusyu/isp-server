...
class HomeController extends Controller {
    async index() {
        ...
        let aa = await this.app.curl('https://20.18.6.16/admin/login');
        console.log(aa)
    ...
    async doNothing() {
        // let result = await this.app.curl('https://20.18.6.16/json/eventType.json', {
        //     //data: { username: 'admin', password: '111111' },
        //     method: 'GET',
        //     headers: {
        //         'Cookie': 'secneflag=0; JSESSIONID=55BD940D9EE87C23F2FE89CA6BD09C75',
        //     },
        //     dataType: 'json',
        // });
        // console.log(result);
